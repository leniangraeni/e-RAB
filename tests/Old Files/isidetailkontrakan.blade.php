...
@section('content')
	...
	<div class="row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
							<div class="col-sm-12"><label><input name="parkiran" type="checkbox" id="parkiran"> Parkiran</label></div>
							<div class="col-sm-12"><label><input name="wifi" type="checkbox" id="wifi"> Wi-Fi</label></div>
							<div class="col-sm-12"><label><input name="ac" type="checkbox" id="ac"> AC</label></div>
							<div class="col-sm-12"><label><input name="dapur" type="checkbox" id="dapur"> Dapur</label></div>
							<div class="col-sm-12"><label><input name="ruangtamu" type="checkbox" id="ruangtamu"> Ruang tamu</label></div>
							<div class="input-group col-sm-12">
								...
								<div class="col-sm-3"><input type="text" name="keteranganlaundry" class="form-control" id="keteranganlaundry" placeholder="Keterangan" style="display:none"></div>
							</div>
							<div class="input-group col-sm-12">
								<div class="col-sm-3"><label><input name="listrik" type="checkbox" id="listrik" onclick="showKeteranganFasilitas()"> Listrik</label></div>
								<div class="col-sm-3"><input name="keteranganlistrik" type="text" class="form-control" id="keteranganlistrik" placeholder="Keterangan" style="display:none"></div>
							</div>
							<div class="col-sm-12"><label><input name="kasur" type="checkbox" id="kasur"> Kasur</label></div>						
							<div class="col-sm-12"><label><input name="meja" type="checkbox" id="meja"> Meja</label></div>
							<div class="col-sm-12"><label><input name="kursi" type="checkbox" id="kursi"> Kursi</label></div>
							<div class="col-sm-12"><label><input name="lemari" type="checkbox" id="lemari"> Lemari</label></div>
							<div class="col-sm-12"><label><input name="rak" type="checkbox" id="rak"> Rak</label></div>
					</div>
					<div class="form-group row"> 
							<label class="col-form-label col-sm-2" for="deskripsi">Deskripsi tambahan:</label>
							<div class="col-sm-9">
								<div class="input-group">
									<textarea name="deskripsi" rows="5" cols="50" class="form-control" id="deskripsi" placeholder="Masukkan deskripsi lain yang ingin ditambahkan"></textarea>
							</div>
							</div>
					</div>
			</div>
